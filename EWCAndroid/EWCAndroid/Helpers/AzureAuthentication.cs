...
namespace EWCAndroid.Helpers
{
	public class AzureAuthentication 
	{
		...
		AzureAuthentication()
		{
			...
			HttpMessageHandler[] azureHandlers = new HttpMessageHandler[1];
			azureHandlers [0] =  new NativeMessageHandler ();
...
//				return string.Empty;
//			}
			return	AccountStorageKeys.AuthProvider.ToString().ToLower();
		}
...
//				}
		...
		//			{
		//				//BigTed.BTProgressHUD.Show ("Re-Authenticating...", -1, BigTed.ProgressHUD.MaskType.Black);
		//
		//				try
		//				{
